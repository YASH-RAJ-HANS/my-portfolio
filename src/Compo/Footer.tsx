...
import { FaCoffee, FaGithub, FaInstagram, FaLinkedin, FaReddit, FaTwitter, FaYoutube } from "react-icons/fa";
...
const Footer = () => {
  ...
  return (
    <div className="w-full relative overflow-hidden">
        ...
        width={600}
      />
      <footer className="footer footer-center text-white bg-zinc-700 p-10 z-1">
        <aside>
